...
var largeStationList = _.filter(bikeArrayClean, function(subArray){
  return subArray[3] > 20;
});

console.log(largeStationList);

var countObject = _.countBy(largeStationList,function(subArray){
  return (subArray[3] > 20);

});
var largeStationCount = countObject[true];
